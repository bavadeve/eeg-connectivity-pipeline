...
OPTIONS.ARTFCTPREPROC.saveData        = 'yes'; % 'string': ('yes' or 'no') to determine whether data will be saved
OPTIONS.ARTFCTPREPROC.pathsFcn        = 'setPaths'; % 'string': pathScript name
OPTIONS.ARTFCTPREPROC.cutintrials     = 'yes'; % 'string': ('yes' or 'no') to determine whether to cut trials
OPTIONS.ARTFCTPREPROC.triallength     = OPTIONS.artifacttrllength; % [ number ]: triallength used for artifact detection
OPTIONS.ARTFCTPREPROC.overwrite       = 'yes'; % 'string': ('yes' or 'no') to determine whether to overwrite
OPTIONS.ARTFCTPREPROC.analyses        = {'kurtosis','variance', 'flatline', 'abs'}; % { cell }: list of analyses to be performed (can be 'kurtosis', 'variance', 'flatline', 'abs', 'range', 'jump')
